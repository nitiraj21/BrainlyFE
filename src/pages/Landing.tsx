...
<div className=' relative overflow-hidden overflow-x-hidden scroll-smooth transform-gpu will-change-transform pb-80'>
<ContentModal2
  open={modalOpen}
...
Store Anything, Even This.
  ...
  <div className='flex flex-cols items-center justify-center gap-4'>
<Card
    type="youtube"
...
<Card
    ...
    link="https://www.youtube.com/watch?v=ULVu2VNM_54"
    contentId="1"
    onDelete={() => {}}
    landing={true}
  />
